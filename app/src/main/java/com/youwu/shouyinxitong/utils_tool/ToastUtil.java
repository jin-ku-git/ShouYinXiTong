...
import com.youwu.shouyinxitong.dialog.TipDialog;
...
public class ToastUtil {
    ...
    private static void showToast(@StringRes int resId, int duration) {
        showToast(AppApplication.getInstance().getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void showToast(@StringRes int resId, int duration, Object... args) {
        showToast(String.format(AppApplication.getInstance().getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void showToast(CharSequence text, int duration) {
        ...
        if (sToast == null) {
            sToast = Toast.makeText(AppApplication.getInstance().getContext(), text, duration);
        } else {
            sToast.setText(text);
    ...
    public static void showTipToast(Context context, String message) {
