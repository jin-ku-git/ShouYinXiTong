...
import com.youwu.shouyinxitong.databinding.ActivityGoodsConfirmListBinding;
...
import com.youwu.shouyinxitong.ui.order.SellOrderListItemViewModel;
...
public class GoodsConfirmActivity extends BaseActivity<ActivityGoodsConfirmListBinding, GoodsConfirmViewModel> {
    ...
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.activity_goods_confirm_list;
    }
    ...
    public void initViewObservable() {
        ...
        viewModel.orderBeanEvent.observe(this, new Observer<OrderBean>() {
            ...
            public void onChanged(OrderBean orderBeans) {
                ...
                GoodsConfirmItemViewModel itemViewModels = new GoodsConfirmItemViewModel(viewModel, orderBean);
                viewModel.observableList.set(currentType,itemViewModels);
                currentType=orderBeans.getPosition();
                orderBeans.setSelect(1);
                GoodsConfirmItemViewModel itemViewModel = new GoodsConfirmItemViewModel(viewModel, orderBeans);
                viewModel.observableList.set(orderBeans.getPosition(),itemViewModel);
                orderBean=orderBeans;

                List<GoodsConfirmOrderItemViewModel> data = new ArrayList<>();
                for (int i=0;i<orderBeans.getOrder_details().size();i++){
                    ...
                    GoodsConfirmOrderItemViewModel itemViewModelss = new GoodsConfirmOrderItemViewModel(viewModel, orderDetailsBean);
