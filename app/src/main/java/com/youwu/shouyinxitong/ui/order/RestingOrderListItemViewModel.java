...
public class RestingOrderListItemViewModel extends ItemViewModel<SellOrderListViewModel> {
    ...
    public RestingOrderListItemViewModel(@NonNull SellOrderListViewModel viewModel, OrderBean.OrderDetailsBean entity) {
        super(viewModel);
