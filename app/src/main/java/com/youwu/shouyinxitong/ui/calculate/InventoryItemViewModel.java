...
public class InventoryItemViewModel extends ItemViewModel<InventoryViewModel> {
    ...
    public InventoryItemViewModel(@NonNull InventoryViewModel viewModel, InventoryTypeBean.GoodsTypeBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.observableList.indexOf(InventoryItemViewModel.this);
