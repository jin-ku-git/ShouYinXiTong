...
public class ApplyOrderItemViewModel extends ItemViewModel<ApplyOrderViewModel> {
    public ObservableField<OrderBean> entity = new ObservableField<>();
    public Drawable drawableImg;
    public int GONE= View.GONE;
    public int VISIBLE= View.VISIBLE;

    public ApplyOrderItemViewModel(@NonNull ApplyOrderViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.ApplyOrdersList.indexOf(ApplyOrderItemViewModel.this);
            entity.get().setPosition(position);
            viewModel.orderLiveData.setValue(entity.get());
        }
    });
