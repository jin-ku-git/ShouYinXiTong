...
public class SellOrderListItemViewModel extends ItemViewModel<SellOrderListViewModel> {
    public ObservableField<OrderBean> entity = new ObservableField<>();
    public Drawable drawableImg;
    public int GONE= View.GONE;
    public int VISIBLE= View.VISIBLE;

    public SellOrderListItemViewModel(@NonNull SellOrderListViewModel viewModel, OrderBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.observableList.indexOf(SellOrderListItemViewModel.this);
