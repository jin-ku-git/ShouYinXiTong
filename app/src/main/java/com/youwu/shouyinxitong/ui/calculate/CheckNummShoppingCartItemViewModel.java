...
public class CheckNummShoppingCartItemViewModel extends ItemViewModel<CheckNumViewModel> {
    ...
    public CheckNummShoppingCartItemViewModel(@NonNull CheckNumViewModel viewModel, CommodityDetailBean entity) {
        super(viewModel);
    ...
    public BindingCommand deleteOnClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.shoppingCartList.indexOf(CheckNummShoppingCartItemViewModel.this);
