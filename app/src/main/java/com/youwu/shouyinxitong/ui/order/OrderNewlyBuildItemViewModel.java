...
public class OrderNewlyBuildItemViewModel extends ItemViewModel<OrderNewlyBuildViewModel> {
    ...
    public OrderNewlyBuildItemViewModel(@NonNull OrderNewlyBuildViewModel viewModel, InventoryTypeBean.GoodsTypeBean entity) {
        super(viewModel);
    ...
    public BindingCommand itemClick = new BindingCommand(new BindingAction() {
        ...
        public void call() {
            ...
            //拿到position
            int position = viewModel.observableList.indexOf(OrderNewlyBuildItemViewModel.this);
