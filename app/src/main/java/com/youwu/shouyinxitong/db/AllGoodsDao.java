...
//    private List<YWGoodBean.SpecsBean> specs;
    ...
    private final String[] GOODS_COLUMNS = new String[]{"id", "category_id", "image",
            ...
            , "discount", "unit", "cost_price", "ratio_base", "ratio_goods_id", "ratio_unit", "category_name","store_goods_id","group_value",};
    ...
    public boolean isDataExist() {
        ...
        try {
            ...
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, new String[]{"COUNT(id)"}, null, null, null, null, null);
...
//                    contentValues.put("specs", MyApplication.gson.toJson(goodsBean.getSpecs()) + "");
                    ...
                    db.insert(goodsDBHelper.ALLGOODS_TABLE_NAME, null, contentValues);

//                    db.execSQL("insert into " +  goodsDBHelper.ALLGOODS_TABLE_NAME + " (Id, GoodsName, Repertory, Price,ImgUrl,Type) values (" + gId + "," + gName +","+ gRepertory + "," + gPrice + "," + gImg + "," + gType + ")");
                }
            }
    ...
    public int getAllGoodsNum() {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            // select * from Goods
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, null, null, null, null, null);
    ...
    public YWGoodBean getGoodInfoByGoodSku(String sku) {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, "sku = ?", new String[]{sku}, null, null, null);
    ...
    public List<YWGoodBean> getGoodListByCategoryId(String category_id) {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, "category_id = ?",
...
//                }
    ...
    public boolean updateIfNotExistById(YWGoodBean goodsBean) {
        ...
        try {
            ...
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, "id = ?", new String[]{goodsBean.getId()}, null, null, null);
            Log.e(TAG, "cursor  " + cursor);
...
//                contentValues.put("specs", MyApplication.gson.toJson(goodsBean.getSpecs()));
                ...
                contentValues.put("store_goods_id", goodsBean.getStore_goods_id());
                contentValues.put("group_value", goodsBean.getGroup_value());
                db.update(goodsDBHelper.ALLGOODS_TABLE_NAME, contentValues,
                        "id = ?",
                        new String[]{goodsBean.getId()});
//                db.delete(goodsDBHelper.ALLGOODS_TABLE_NAME,"good_id = ?",new String[]{goodBean.getGood_id()});
                return true;
            } else {
                ContentValues contentValues = new ContentValues();
//                contentValues.put("id", Integer.parseInt(goodsBean.getId()));
...
//                contentValues.put("specs", MyApplication.gson.toJson(goodsBean.getSpecs()));
                ...
                contentValues.put("store_goods_id", goodsBean.getStore_goods_id());
                contentValues.put("group_value", goodsBean.getGroup_value());
                db.insert(goodsDBHelper.ALLGOODS_TABLE_NAME, null, contentValues);//执行插入操作
                return true;
            }
        } catch (Exception e) {
            Log.e(TAG, "", e);
    ...
    public List<YWGoodBean> getGoodListByPinYin(String goodInfo) {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(DBHelper.ALLGOODS_TABLE_NAME, new String[]{GOODS_COLUMNS[0], GOODS_COLUMNS[1],
                            ...
                            , GOODS_COLUMNS[11], GOODS_COLUMNS[12], GOODS_COLUMNS[13], GOODS_COLUMNS[14], GOODS_COLUMNS[15],GOODS_COLUMNS[16],GOODS_COLUMNS[17]},
                    "letters LIKE ?",
...
//            Log.e(TAG,"cursor  "+cursor);
    ...
    public YWGoodBean getGoodInfoByGoodCode(String goodCode) {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, "sku = ?", new String[]{goodCode}, null, null, null);
            Log.e(TAG, "cursor  " + cursor);
            if (cursor.getCount() > 0) {
                Log.e("daodata", "cursor  count  " + cursor.getCount());
                if (cursor.moveToNext()) {
    ...
    public boolean deleteIfExistByGoodId(String goodId) {
        ...
        try {
            db = goodsDBHelper.getReadableDatabase();
            cursor = db.query(goodsDBHelper.ALLGOODS_TABLE_NAME, GOODS_COLUMNS, "good_id = ?", new String[]{goodId}, null, null, null);
            Log.e(TAG, "cursor  " + cursor);
            if (null != cursor && cursor.getCount() > 0) {
                db.delete(goodsDBHelper.ALLGOODS_TABLE_NAME, "good_id = ?", new String[]{goodId});
                return true;
            } else {
                return true;
            }
...
//        }.getType()));
    ...
    public void deleteAllData() {
        ...
        db = goodsDBHelper.getReadableDatabase();
        try {
            db.execSQL("delete from " + goodsDBHelper.ALLGOODS_TABLE_NAME);
        } catch (Exception e) {
            Log.e(TAG, "", e);
        } finally {
            if (db != null) {
