package com.youwu.shouyinxitong.utils;
...
//    public static String baseUrl = "https://www.oschina.net/";
    public static String baseUrl = "https://xmzcdevapi.youwuu.com/api_cashier_restaurant/";//PHP根路径
//    public static String baseUrl = "http://local-restaurant.cn/mini";//测试接口---吉王伟
