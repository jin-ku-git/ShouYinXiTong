...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    protected void registorUIChangeLiveDataCallBack() {
        ...
        //2021/11/06 加
        //loadingShapeDialog 显示
        viewModel.getUC().getShowShapeDialogEvent().observe(this, new Observer<String>() {
            @Override
            public void onChanged(String title) {
                showShapeDialog(title);
            }
        });
        //loadingShapeDialog 消失
        viewModel.getUC().getDismissShapeDialogEvent().observe(this, new Observer<Void>() {
            @Override
            public void onChanged(@Nullable Void v) {
                dismissShapeDialog();
            }
...
//        }
        if (shapeLoadingDialog != null) {
            ...
            shapeLoadingDialog = builder.show();
        }
    }
